 ...
 */
export function instanceOfCourseLogsIdDelete200Response(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CourseLogsIdDelete200ResponseFromJSON(json: any): CourseLogsIdDelete200Response {
    return CourseLogsIdDelete200ResponseFromJSONTyped(json, false);
}

export function CourseLogsIdDelete200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CourseLogsIdDelete200Response {
...
export function CourseLogsIdDelete200ResponseToJSON(value?: CourseLogsIdDelete200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
