...
export function SchedulesGetRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SchedulesGetRequest {
...
export function SchedulesGetRequestToJSON(value?: SchedulesGetRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
