 ...
 */
export function instanceOfClassroomWithCourseCoursesInner(
  value: object
): boolean {
  let isInstance = true;
...
export function ClassroomWithCourseCoursesInnerFromJSON(
  json: any
): ClassroomWithCourseCoursesInner {
  return ClassroomWithCourseCoursesInnerFromJSONTyped(json, false);
}

export function ClassroomWithCourseCoursesInnerFromJSONTyped(
  json: any,
  ...
  return {
    ...
    classroom: !exists(json, "classroom")
      ? undefined
      : ClassroomFromJSON(json["classroom"]),
    subject: !exists(json, "subject")
      ? undefined
      : SubjectFromJSON(json["subject"]),
    scores: !exists(json, "scores")
      ? undefined
      : (json["scores"] as Array<any>).map(ScoreFromJSON),
...
export function ClassroomWithCourseCoursesInnerToJSON(
  value?: ClassroomWithCourseCoursesInner | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    scores:
      value.scores === undefined
        ? undefined
        : (value.scores as Array<any>).map(ScoreToJSON),
    createdAt:
