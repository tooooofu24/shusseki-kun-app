...
export function InvitationsGet200ResponseFromJSON(
  json: any
): InvitationsGet200Response {
  return InvitationsGet200ResponseFromJSONTyped(json, false);
}

export function InvitationsGet200ResponseFromJSONTyped(
  json: any,
  ...
  return {
    data: !exists(json, "data")
      ? undefined
      : (json["data"] as Array<any>).map(UserInvitationFromJSON),
  };
}

export function InvitationsGet200ResponseToJSON(
  value?: InvitationsGet200Response | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    data:
      value.data === undefined
        ? undefined
        : (value.data as Array<any>).map(UserInvitationToJSON),
  };
}
