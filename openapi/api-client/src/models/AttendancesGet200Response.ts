...
export function AttendancesGet200ResponseFromJSON(
  json: any
): AttendancesGet200Response {
  return AttendancesGet200ResponseFromJSONTyped(json, false);
}

export function AttendancesGet200ResponseFromJSONTyped(
  json: any,
  ...
  return {
    data: !exists(json, "data")
      ? undefined
      : (json["data"] as Array<any>).map(AttendanceFromJSON),
  };
}

export function AttendancesGet200ResponseToJSON(
  value?: AttendancesGet200Response | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    data:
      value.data === undefined
        ? undefined
        : (value.data as Array<any>).map(AttendanceToJSON),
  };
}
