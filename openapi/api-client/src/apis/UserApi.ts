...
export interface UserApiInterface {
   ...
   */
  usersCurrentGetRaw(
    requestParameters: UsersCurrentGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<UsersCurrentGet200Response>>;
  ...
  usersCurrentGet(
    requestParameters: UsersCurrentGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<UsersCurrentGet200Response>;
...
export class UserApi extends runtime.BaseAPI implements UserApiInterface {
  ...
  async usersCurrentGetRaw(
    ...
    if (
      ...
      throw new runtime.RequiredError(
        "xTenantUID",
        "Required parameter requestParameters.xTenantUID was null or undefined when calling usersCurrentGet."
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      UsersCurrentGet200ResponseFromJSON(jsonValue)
    );
  }
  ...
  async usersGetRaw(
    ...
    if (
      ...
      throw new runtime.RequiredError(
        "xTenantUID",
        "Required parameter requestParameters.xTenantUID was null or undefined when calling usersGet."
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      UsersGet200ResponseFromJSON(jsonValue)
    );
  }
  ...
  async usersIdDeleteRaw(
    ...
    if (
      ...
      throw new runtime.RequiredError(
        "xTenantUID",
        "Required parameter requestParameters.xTenantUID was null or undefined when calling usersIdDelete."
      );
    }
  ...
  async usersIdGetRaw(
    ...
    if (
      ...
      throw new runtime.RequiredError(
        "xTenantUID",
        "Required parameter requestParameters.xTenantUID was null or undefined when calling usersIdGet."
      );
    }
